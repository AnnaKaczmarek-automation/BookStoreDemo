...
public class BirdsCategoryPage extends BasePage{
    ...
    public void chooseRandomBird() {
        chooseRandomMainCategoryBird();
        log.info("Random dog was chosen from main category");
        chooseRandomSubCategoryRBird();
        log.info("Random dog was chosen from sub category");
    }

    private void chooseRandomMainCategoryBird() {
    ...
    private void chooseRandomSubCategoryRBird() {
